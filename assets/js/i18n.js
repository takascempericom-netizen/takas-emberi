...
const DICT = {
  ...
  tr: {
    ...
    "messages.start": "Sol taraftan bir sohbet seçin.",
    "messages.to": "Alıcı",
    "messages.type": "Mesaj yaz…",
    ...
    "messages.selectAll": "Tümünü Seç",
    "messages.selected.count": "{n} seçili",
    "messages.delete.selected": "Seçilenleri Sil",
    "messages.thread.none": "Sohbet yok.",
    "messages.thread.pick": "Sohbet seç",
    "messages.thread.openPrompt": "Henüz mesaj yok. İlk mesajı sen gönder.",
    "messages.permadelete.confirm.one": "Bu sohbet KALICI olarak silinsin mi?\nTüm mesajlar geri alınamaz şekilde silinir.",
    "messages.permadelete.confirm.multi": "{n} sohbet KALICI olarak silinsin mi?\nTüm mesajlar geri alınamaz şekilde silinir.",
    ...
    "profile.changePhoto": "Profil Resmini Değiştir",
    "profile.rating": "{val} / 5 ({n} oy)",
    "profile.pass.current": "Mevcut şifre",
    "profile.pass.new": "Yeni şifre",
    "profile.pass.new2": "Yeni şifre (tekrar)",
    "profile.pass.confirm": "Onayla",
    "tabs.live": "Yayındaki İlanlar",
    "tabs.pending": "Onay Bekleyen",
    "tabs.expired": "Süresi Dolan",
    ...
    // İlan verme (form)
    "page.listing.title": "İlan Ver",
    "listing.title": "İlan Başlığı",
    "listing.desc": "Açıklama",
    "listing.photos": "Fotoğraflar",
    "listing.photos.note": "En fazla 5 fotoğraf yükleyebilirsiniz.",
    "listing.city": "Şehir",
    "listing.district": "İlçe",
    "listing.category": "Kategori",
    "listing.subcategory": "Alt Kategori",
    "listing.condition": "Durum",
    "listing.submit": "İlanı Gönder",
    "ui.select": "Seçiniz",
    // condition options
    "cond.parts": "Parçaniyetine",
    "cond.bad": "Kötü",
    "cond.mid": "Orta",
    "cond.good": "İyi",
    "cond.new": "Sıfır",
  ...
  en: {
    ...
    "messages.start": "Pick a chat from the left.",
    ...
    "messages.selected.count": "{n} selected",
    "messages.delete.selected": "Delete Selected",
    "messages.thread.none": "No conversations.",
    "messages.thread.pick": "Pick a chat",
    "messages.thread.openPrompt": "No messages yet. Send the first one.",
    "messages.permadelete.confirm.one": "Delete this chat PERMANENTLY?\nAll messages will be irreversibly removed.",
    "messages.permadelete.confirm.multi": "Delete {n} chats PERMANENTLY?\nAll messages will be irreversibly removed.",
    ...
    "profile.rating": "{val} / 5 ({n} votes)",
    "profile.pass.current": "Current password",
    "profile.pass.new": "New password",
    "profile.pass.new2": "New password (repeat)",
    "profile.pass.confirm": "Confirm",
    "tabs.live": "Live Listings",
    "tabs.pending": "Pending Approval",
    ...
    "page.listing.title": "Post Listing",
    "listing.title": "Listing Title",
    "listing.desc": "Description",
    "listing.photos": "Photos",
    "listing.photos.note": "You can upload up to 5 photos.",
    "listing.city": "City",
  ...
  ar: {
    ...
    "messages.start": "اختر محادثة من اليسار.",
    "messages.to": "المستلم",
    ...
    "messages.selectAll": "تحديد الكل",
    "messages.selected.count": "{n} محدد",
    "messages.delete.selected": "حذف المحدد",
    "messages.thread.none": "لا توجد محادثات.",
    "messages.thread.pick": "اختر محادثة",
    "messages.thread.openPrompt": "لا توجد رسائل بعد. أرسل الأولى.",
    "messages.permadelete.confirm.one": "هل تريد حذف هذه المحادثة نهائيًا؟\nستُحذف جميع الرسائل بلا رجعة.",
    "messages.permadelete.confirm.multi": "حذف {n} محادثة نهائيًا؟\nستُحذف جميع الرسائل بلا رجعة.",
    ...
    "profile.changePhoto": "تغيير صورة الملف",
    "profile.rating": "{val} / 5 ({n} صوتًا)",
    "profile.pass.current": "كلمة المرور الحالية",
    "profile.pass.new": "كلمة المرور الجديدة",
    "profile.pass.new2": "تأكيد كلمة المرور الجديدة",
    "profile.pass.confirm": "تأكيد",
    "tabs.live": "إعلانات نشطة",
    "tabs.pending": "بانتظار الموافقة",
    "tabs.expired": "منتهية",
